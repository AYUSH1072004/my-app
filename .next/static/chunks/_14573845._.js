...
const SignInPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        // 🔥 No backend, so we simulate login
        if (form.email === 'demo@example.com' && form.password === 'password') {
            toast.success('Login successful!');
            // In real app: call backend and set context user
...
_s(SignInPage, "CRQMSoNFsEVF3KDHBKgg3OAP3ZM=", false, function() {
    return [
...
//# sourceMappingURL=_14573845._.js.map